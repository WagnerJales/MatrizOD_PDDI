...
municipios_coords = {
    "Alcântara": [-4.737, -46.039],
    "Anajatuba": [-4.366, -44.52],
    "Anapurus": [-5.234, -43.104],
    "Araguanã": [-5.038, -47.621],
    "Arari": [-2.636, -45.111],
    "Axixá": [-4.819, -47.43],
    "Bacabal": [-4.224, -44.783],
    "Bacabeira": [-4.482, -46.499],
    "Bacuri": [-2.923, -44.99],
    "Barreirinhas": [-5.704, -46.924],
    "Bequimão": [-3.802, -42.81],
    "Brejo": [-3.588, -43.007],
    "Buriti": [-2.978, -43.17],
    "Cachoeira Grande": [-2.957, -43.599],
    "Cafeteira": [-5.792, -44.7],
    "Cajari": [-5.451, -44.524],
    "Cantanhede": [-3.534, -45.016],
    "Caxias": [-4.865, -43.363],
    "Codó": [-4.265, -46.01],
    ...
    "Morros": [-3.493, -45.822],
    "Olinda Nova do Maranhão": [-4.419, -44.065],
    "Paço do Lumiar": [-2.516, -44.101],
    "Pedreiras": [-4.21, -43.642],
    "Pedro do Rosário": [-4.163, -45.151],
    "Penalva": [-4.31, -45.15],
    ...
    "Raposa": [-5.184, -43.246],
    "Ribeira": [-3.399, -45.239],
    "Rosário": [-2.934, -44.254],
    "Santa Inês": [-3.653, -45.377],
    "Santa Rita": [-3.139, -44.325],
    "Santo Amaro": [-4.622, -47.781],
    "São Bento": [-4.646, -46.943],
    "São Domingos": [-4.192, -44.526],
    "São Domingos do Azeitão": [-4.688, -47.316],
    "São José de Ribamar": [-2.561, -44.054],
    "São Luís": [-2.531, -44.307],
    "São Mateus do Maranhão": [-3.515, -44.659],
    "São Pedro dos Crentes": [-4.566, -45.369],
    "São Raimundo das Mangabeiras": [-5.383, -44.35],
    "São Vicente Ferrer": [-2.608, -45.902],
